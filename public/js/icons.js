...
const ARG_ICONS = {
  ...
  // Argument — opposing speech bubbles (debate).
  Argument: `${SVG_OPEN}<path d="M4 5h8a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H8l-4 3V7a2 2 0 0 1 2-2z"/><path d="M14 9h4a2 2 0 0 1 2 2v5l-2.5-2H13"/></svg>`,
  // Other — generic tag.
